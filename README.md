...
| - | - | - | - | - |
| Flatpak | [wiki](https://github.com/an-anime-team/honkers-launcher/wiki/Installation#-any-distribution-flatpak) | [Flathub](https://flathub.org/apps/moe.launcher.honkers-launcher) | Any (Fedora, Pop!_OS, SteamOS / Steam Deck, etc.) | NelloKudo |
