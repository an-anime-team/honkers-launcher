...
ultra-quality = Cực chất
quality = Chất lượng
balanced = Cân bằng
performance = Hiệu suất

gamemode = Chế độ trò chơi
gamemode-description = Ưu tiên trò chơi hơn các tiến trình
...
power-saving-description = Tự động đặt giới hạn FPS thành 10 và mức độ ưu tiên xử lý thấp khi không chơi (ví dụ: tắt tab)
