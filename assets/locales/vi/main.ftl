...
loading-launcher-state--voice =  Đang tải trạng thái Launcher: xác minh thuyết minh {$locale}
...
main-window--patch-unavailable-tooltip = Máy chủ vá không khả dụng và Launcher không thể xác minh trạng thái vá. Bạn có thể chạy trò chơi nhưng với rủi ro
main-window--patch-outdated-tooltip = Bản vá đã lỗi thời hoặc đang ở trạng thái chuẩn bị nên không có sẵn để sử dụng. Quay lại sau để xem trạng thái
