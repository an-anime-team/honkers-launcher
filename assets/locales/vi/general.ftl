...
update-background-description = Tải xuống ảnh nền chính thức cho Launcher. Thay vào đó, bạn có thể tắt nó để sử dụng hình ảnh của mình
...
game-voiceovers = Thuyết minh trò chơi
game-voiceovers-description = Danh sách thuyết minh trò chơi đã tải xuống. Bạn có thể chọn chúng trong cài đặt trò chơi
english = Tiếng Anh
japanese = Tiếng Nhật
korean = Tiếng Hàn
chinese = Tiếng Trung

migrate-installation = Di chuyển cài đặt
