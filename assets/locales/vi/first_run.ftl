...
tos-violation-warning-message =
    ...
    Nó làm như vậy bằng cách sử dụng các thành phần hiện có và làm cho trải nghiệm trở nên đơn giản cho người dùng.

    Tuy nhiên, một số thành phần được sử dụng ở đây có khả năng vi phạm Điều khoản dịch vụ của {company-name} dành cho {game-name}.

    Nếu bạn đang sử dụng trình khởi chạy này, tài khoản của bạn có thể bị {company-name}/{company-alter-name} xác định là vi phạm Điều khoản dịch vụ.

    Nếu điều này xảy ra, vì tài khoản của bạn sẽ không tuân theo Điều khoản dịch vụ, nên {company-name}/{company-alter-name} được tự do làm những gì họ muốn. Bao gồm cả việc khóa tài khoản

    Nếu bạn hiểu rủi ro khi thử chơi trò chơi với tư cách không chính thức, hãy nhấn OK để tiếp tục
...
tos-dialog-message =
    ...
    3. Đặt câu hỏi đặc biệt trong Discord hoặc Matrix
...
japanese-game-installation-folder = Thư mục cài đặt game phiên bản Nhật Bản
fps-unlocker-folder = Thư mục Mở khóa FPS
