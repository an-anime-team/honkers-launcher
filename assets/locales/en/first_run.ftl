...
welcome-page-message =
    Hi there! Welcome to the Honkers Launcher
...
sea-game-installation-folder = Southeast Asia game version installation folder
chinese-game-installation-folder = Chinese game version installation folder
taiwanese-game-installation-folder = Taiwanese game version installation folder
korean-game-installation-folder = Korean game version installation folder
